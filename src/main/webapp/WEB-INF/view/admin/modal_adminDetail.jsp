		...
		<div class="modal_box">
	         <ul>
	            ...
	            <li>
	                ...
	                <div class="input_area">
	                	<input type="text" value="${store.storeInfo.storeName }" id="store_name" name="storeName" value="" autocomplete="off" required spellcheck="false" >
	                </div>
                </li>
				...
				<li class="location">
	 			...
	 			<li>
                    <h2>매장 전화번호</h2>
	                <div class="input_area">
	                	<input type="number" value="${store.storeInfo.storePhone }" pattern="\d*" onkeypress="return lenthCheck(this, 11);" id="store_phone_number" name="storePhone" required>
                	</div>
	            </li>
	            ...
	            <li class="min_delevery_price">
                    <h2>최소 배달금액</h2>
	                <div class="input_area">
                		<input type="number" value="${store.storeInfo.minDelevery }" pattern="\d*" onkeypress="return lenthCheck(this, 8);" id="min_delevery_price" name="minDelevery" required>
	                </div>
	            </li>
	            ...
	            <li class="delevery_tip">
                    <h2>배달팁</h2>
	                <div class="input_area">
	                	<input type="number" value="${store.storeInfo.deleveryTip }" pattern="\d*" onkeypress="return lenthCheck(this, 8);" id="delevery_tip" name="deleveryTip" required >
	                </div>
	            </li>
	            ...
	            <li class="delevery_time">
                    <h2>예상 배달시간</h2>
	                <div class="input_area">
	                	<input type="number" value="${store.storeInfo.deleveryTime }" pattern="\d*" onkeypress="return lenthCheck(this, 3);"  pattern="/d*" value="" id="delevery_time" name="deleveryTime" required>
	                </div>
	            </li>
...
<!-- 
		...
		<div id="btn_box">
			<button class="closeB" type="button">취소</button>
			<button type="submit" type="button">추가</button>
		</div>
	</form>
</div>
<!-- 메뉴 추가하기  -->
...
<!-- 메뉴 수정하기  -->
<div class="add_menu_modal menu_modify modal">
	<form action="/admin/menuModify" method="post" enctype="multipart/form-data" onsubmit="return submitCheck();">
		...
		<div id="btn_box">
			<button class="closeB" type="button">취소</button>
			<button type="submit" type="button">수정하기</button>
		</div>
	</form>
</div>
<!-- 메뉴 수정하기  -->
