			...
			<div class="find">
				<div id="find_by_email">
					...
					<div class="auth">
						...
						<input type="text" class="auth_num" name="authNum" readonly maxlength="4"  placeholder="인증번호6자리입력">
						<span class="validity_time"></span>
					</div>
				</div>
				...
				<input type="hidden" name="userId" class="user_id">
				<button class="move_modify">다음</button>
				<form action="/find/password/auth/modify" method="get" onsubmit="return next()">
			</form>
		</div>
	</main>
